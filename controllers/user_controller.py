...
def login():
    return render_template('vitality/login.html')


@app.route('/logout', methods=['GET'])
def logout():
    return render_template('vitality/login.html', error=False, message="You have been successfully logout")


@app.route('/signup', methods=['GET'])
def signup():
    return render_template('vitality/signup.html')
...
def signup_post():
    ...
    if not get_user_by_email(email) is None:
        return render_template('vitality/signup.html', error=True, message="Account with this email already exists")
    ...
    if username and password and email and role != RoleEnum.unknown:
        ...
        return render_template('vitality/signup.html', error=True, message="Oops, fields are incorrect")
...
def login_post():
    ...
    if user is None:
        return render_template('vitality/login.html', error=True, message="Credential are wrong")
